 ...
 * Fetches trades from Supabase, aggregates positions, prices from Alpaca, cash from user_balances.
...
export async function computeEquity(supabase, userId) {
  ...
  try {
    ...
    console.error('computeEquity: Alpaca fetch failed, using entry prices:', err.message)
  }
